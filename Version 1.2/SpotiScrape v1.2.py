...
class SpotifyScraperApp(QMainWindow):
    ...
    def show_instructions(self):
        instructions = """
        How to Use SpotiScrape:

        1. Enter a valid Spotify song URL in the input field.
        2. Click the "Scrape" button to retrieve information of the song.
        3. The artist, album, track and artwork will be displayed.
        4. You can also download the artwork by clicking \n            the "Download Artwork" button.
        5. Use the "Clear" button to reset the input and results.

        Enjoy using SpotiScrape!
        """
